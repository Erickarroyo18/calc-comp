...
happyExpList = Happy_Data_Array.listArray (0,36) ([4192,2096,0,0,0,135,0,24606,16,6160,3076,1538,33537,32768,16384,8192,4096,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","S","Expr","\"True\"","\"False\"","\"not\"","\"and\"","\"or\"","\"=>\"","\"<=>\"","'('","')'","%eof"]
...
action_7 (12) = happyShift action_13
